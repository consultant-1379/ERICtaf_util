...
@API(Internal)
public class ToolbarRadioButtonCollector implements WidgetCollector {

    private SWTBot bot;

    public ToolbarRadioButtonCollector(SWTBot bot) {
        this.bot = bot;
    }
    ...
    public List<WidgetDto> getTarget(WindowDto container) {
        return container.getToolbarRadioButtons();
    }
