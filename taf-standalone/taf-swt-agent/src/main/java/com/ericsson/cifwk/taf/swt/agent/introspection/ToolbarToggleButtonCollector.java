...
@API(Internal)
public class ToolbarToggleButtonCollector implements WidgetCollector {

    private SWTBot bot;

    public ToolbarToggleButtonCollector(SWTBot bot) {
        this.bot = bot;
    }
    ...
    public List<WidgetDto> getTarget(WindowDto container) {
        return container.getToolbarToggleButtons();
    }
