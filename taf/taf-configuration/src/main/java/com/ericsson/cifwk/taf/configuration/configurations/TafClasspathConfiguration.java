...
public class TafClasspathConfiguration extends CompositeConfiguration {

    private final String path;

    public TafClasspathConfiguration(String path) {
        this.path = path;
    }

    public TafClasspathConfiguration build() {
        ...
        builder.forMatching(Pattern.compile(match + "\\.json"))
                .applyEach(ConfigurationProcessor.archiveProcessor(ConfigurationParser.HOST_JSON))
                .build(this);
        builder.forMatching(Pattern.compile(match))
                .applyEach(ConfigurationProcessor.archiveProcessor(ConfigurationParser.PROPERTIES))
                .build(this);
        return this;
    }
